...
namespace TeploPro.Models
{
    public class ReferenceModel
    {
        ...
        public СoefficientsReference CokeCunsumptionCoefficents { get; set; }

        [ForeignKey(nameof(RefId2))]
        public СoefficientsReference FurnanceCapacityCoefficents { get; set; }

        public static ReferenceModel GetDefaultCoefficients()
        {
            return new ReferenceModel
            {
                ...
                RefId1 = 1,
                RefId2 = 1,
                CokeCunsumptionCoefficents = new СoefficientsReference {
                    Id = 1,
                ...
                FurnanceCapacityCoefficents = new СoefficientsReference
                {
                    Id = 2,
